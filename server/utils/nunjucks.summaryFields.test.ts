...
// import { Context, Field, FieldAnswer } from '../../app/utils/fieldDependencyTreeBuilder'
//
describe('server/utils/nunjucks.summaryFields', () => {
  ...
  //       expect(getFieldAnswers(optionsField, ctx)).toEqual(expected)
  //     })
  //
  ...
  //       expect(getFieldAnswers(textField, ctx)).toEqual(expected)
  //     })
  //
  ...
  //       optionsField.type = FieldType.Radio
  //       const ctx = contextWithAnswer('q2', 'free text')
  //       expect(getFieldAnswers(optionsField, ctx)).toEqual([])
  //     })
  //   })
  //
  ...
  //
  //       expect(addNestedField(field, summaryFields, ctx, '/test-page')).toEqual(true)
  ...
  //       }
  //       const ctx = contextWithAnswer('q4', 'val4')
  //       expect(addNestedField(field, [], ctx, '/test-page')).toEqual(false)
  //     })
  //   })
  //
  ...
  //       expect(buildDependencyTree(ctx)).toEqual([])
  //     })
  //
  ...
  //       ]
  //
  //       expect(buildDependencyTree(ctx)).toEqual(expected)
  //     })
  //   })
})
