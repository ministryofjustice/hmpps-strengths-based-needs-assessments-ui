...
describe('Origin: /alcohol-use', () => {
  ...
  describe(`Destination: ${destinations.analysis}`, () => {
    it(`"Drunk alcohol in the last three months routes to "${destinations.analysis}"`, () => {
      ...
      cy.getQuestion('Why does Sam drink alcohol?').getRadio('Cultural or religious practice').clickLabel()
      cy.getQuestion("What's the impact of Sam drinking alcohol?").getRadio('Behavioural').clickLabel()
