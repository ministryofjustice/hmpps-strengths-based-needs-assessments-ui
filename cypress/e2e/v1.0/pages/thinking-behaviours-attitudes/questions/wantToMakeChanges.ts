...
export default (stepUrl: string, summaryPage: string, positionNumber: number) => {
  const question = 'Does Sam want to make changes to their thinking, behaviours and attitudes?'
  const options = [
  ...
  describe(question, () => {
    it(`displays and validates the question`, () => {
      ...
      cy.getQuestion(question).hasValidationError(
        'Select if they want to make changes to their thinking, behaviours and attitudes',
      )
