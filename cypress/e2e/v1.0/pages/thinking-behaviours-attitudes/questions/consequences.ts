export default (stepUrl: string, summaryPage: string, positionNumber: number) => {
  ...
  const options = [
    'Yes, is aware of the consequences of their actions',
    'Sometimes is aware of the consequences of their actions',
    'No, is not aware of the consequences of their actions',
  ]
  ...
  describe(question, () => {
    it(`displays and validates the question`, () => {
      cy.getQuestion(question)
        ...
        .hasHint('This includes towards themselves and to others.')
        .hasRadios(options)
      cy.saveAndContinue()
