export default (stepUrl: string, summaryPage: string, positionNumber: number) => {
  const question = 'Is there evidence that Sam has ever been a perpetrator of domestic abuse?'
  ...
  describe(question, () => {
    it('displays and validates the question', () => {
      ...
      cy.getQuestion(question).hasValidationError(
        'Select if there is any evidence that they have ever been perpetrator of domestic abuse',
      )
    ...
    it('displays the conditional options for "Yes"', () => {
      ...
      cy.getQuestion(question)
        ...
        .hasTitle('Who was this committed against?')
        .hasHint(null)
