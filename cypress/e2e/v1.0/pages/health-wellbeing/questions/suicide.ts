export default (stepUrl: string, summaryPage: string, positionNumber: number) => {
  const question = 'Has Sam ever attempted suicide or had suicidal thoughts?'
  ...
  describe(question, () => {
    ...
    it(`displays and validates the question`, () => {
      ...
      cy.getQuestion(question).hasValidationError('Select if they have ever attempted suicide or had suicidal thoughts')
