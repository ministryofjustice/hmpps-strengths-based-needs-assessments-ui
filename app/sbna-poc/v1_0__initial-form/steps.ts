...
const stepOptions: FormWizard.Steps = {
  ...
  '/no-drug-use-summary': {
    ...
    next: 'no-drug-use-analysis-complete#practitioner-analysis',
    template: 'forms/sbna-poc/drugs-no-usage-summary-analysis',
    section: 'drug-use',
    sectionProgressRules: [{ fieldCode: 'drug_use_analysis_section_complete', conditionFn: () => 'YES' }],
  },
  '/no-drug-use-analysis-complete': {
    ...
    controller: SaveAndContinueController,
    fields: [],
    template: 'forms/sbna-poc/drugs-no-usage-summary-analysis-complete',
    section: 'drug-use',
  },
  '/finance': {
    pageTitle: 'Finance',
