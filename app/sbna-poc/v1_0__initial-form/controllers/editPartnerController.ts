...
class EditPartnerController extends BaseSaveAndContinueController {
  ...
  async saveValues(req: FormWizard.Request, res: Response, next: NextFunction) {
    try {
      ...
      await this.apiService.updateAnswersInCollection(assessmentUUID, 'living_with_partner', {
...
export default EditPartnerController
